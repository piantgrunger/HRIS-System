...
/**
 * Class m181206_231815_alterhiy
 */
class m181206_231815_alterhiy extends Migration
{
    /**
     * {@inheritdoc}
     */
...
BEGIN
        ...
        case when  ((coalesce(j.ikkd*j.nilai_jabatan,j.tpp_statis,g.ikkd*g.nilai_jabatan)) +(coalesce(j.ikkd*j.nilai_jabatan,j.tpp_statis,g.ikkd*g.nilai_jabatan) *100/100 ))
          ...
          +coalesce(j.tambahan_tunjangan_kinerja,0)
          end
          from tb_m_pegawai p
    ...
    {
        echo "m181206_231815_alterhiy cannot be reverted.\n";
