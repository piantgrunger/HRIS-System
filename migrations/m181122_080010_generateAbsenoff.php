...
/**
 * Class m181122_080010_generateAbsenoff
 */
class m181122_080010_generateAbsenoff extends Migration
{
    /**
     * {@inheritdoc}
     */
...
BEGIN
  ...
  insert into tb_mt_absen(tgl_absen,id_pegawai,masuk_kerja,pulang_kerja,id_jenis_absen)
   ...
   left join tb_m_pegawai m on m.id_unit_kerja=id_unit_kerja
...
END");
    ...
    {
        echo "m181122_080010_generateAbsenoff cannot be reverted.\n";
