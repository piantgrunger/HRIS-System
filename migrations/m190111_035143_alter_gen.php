...
/**
 * Class m190111_035143_alter_gen.
 */
class m190111_035143_alter_gen extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        CREATE DEFINER=`root`@`localhost` PROCEDURE `generate_absen`(IN `tgl_awal` DATE, IN `tgl_akhir` DATE, IN `id_satuan_kerja` INT
        ...
        BEGIN
          ...
          insert into tb_mt_absen(tgl_absen,id_pegawai,masuk_kerja,pulang_kerja,id_jenis_absen)
           ...
           left join tb_m_jenis_absen ja on ja.nama_jenis_absen = case when (ds.jam_masuk='00:00:00' and jam_pulang='00:00:00')
    ...
    {
        echo "m190111_035143_alter_gen cannot be reverted.\n";
