...
/**
 * Class m181206_095052_alterhitung.
 */
class m181206_095052_alterhitung extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->execute("CREATE DEFINER=`root`@`localhost` PROCEDURE `hitung_tunjangan`(IN `tgl_awal` DATE, IN `tgl_akhir` DATE, IN `id_satuan_kerja` INT, IN `id` INT
         ...
         and p.id_satuan_kerja=id_satuan_kerja;
          ...
          and p.id_satuan_kerja=id_satuan_kerja;
           ...
           insert into tb_dt_hitung_tunjangan(id_hitung_tunjangan,id_pegawai,jumlah_absen,total_jam_potong,tunjangan_tpp,capaian_kinerja,tambahan_tpp,total_tunjangan)
            select id, p.id_pegawai,count(a.id_absen),sum(coalesce(a.total_jam_potong,0)),coalesce(j.ikkd*j.nilai_jabatan*2 ,j.tpp_statis*2,g.ikkd*g.nilai_jabatan*2),100,j.tambahan_tunjangan_kinerja,
    ...
    {
        echo "m181206_095052_alterhitung cannot be reverted.\n";
