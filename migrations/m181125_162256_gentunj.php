...
/**
 * Class m181125_162256_gentunj
 */
class m181125_162256_gentunj extends Migration
{
    /**
     * {@inheritdoc}
     */
...
case when  ((coalesce(j.ikkd*j.nilai_jabatan,j.tpp_statis,g.ikkd*g.nilai_jabatan)/2) +(coalesce(j.ikkd*j.nilai_jabatan,j.tpp_statis,g.ikkd*g.nilai_jabatan)/2 *100/100 ))
...
END");
    ...
    {
        echo "m181125_162256_gentunj cannot be reverted.\n";
