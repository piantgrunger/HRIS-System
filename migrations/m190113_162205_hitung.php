...
/**
 * Class m190113_162205_hitung
 */
class m190113_162205_hitung extends Migration
{
    /**
     * {@inheritdoc}
     */
...
BEGIN
        ...
        case when  ((coalesce(j1.tunjangan_tpp/2,j.ikkd*j.nilai_jabatan,j.tpp_statis,g.ikkd*g.nilai_jabatan)) +( coalesce(j1.tunjangan_tpp/2, j.ikkd*j.nilai_jabatan,j.tpp_statis,g.ikkd*g.nilai_jabatan) *100/100 ))
          ...
          end+coalesce(j1.tambahan_tpp,0)+coalesce(0.635/100*count(mb.id_banding),0),+coalesce(0.635/100*count(mb.id_banding),0)
          from tb_m_pegawai p
          ...
          left outer join tb_mt_banding mb on mb.id_pegawai = p.id_pegawai and mb.status_banding = 'Diterima'
    ...
    {
        echo "m190113_162205_hitung cannot be reverted.\n";
