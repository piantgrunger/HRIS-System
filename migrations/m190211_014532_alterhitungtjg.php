...
/**
 * Class m190211_014532_alterhitungtjg
 */
class m190211_014532_alterhitungtjg extends Migration
{
    /**
     * {@inheritdoc}
     */
...
BEGIN
         ...
         create temporary table tp_banding (
          ...
          and p.id_satuan_kerja=id_satuan_kerja;
           ...
           insert into tb_dt_hitung_tunjangan(id_hitung_tunjangan,id_pegawai,jumlah_absen,total_jam_potong,tunjangan_tpp,capaian_kinerja,tambahan_tpp,total_tunjangan,total_banding)
            select id, p.id_pegawai,count(a.id_absen),sum(coalesce(a.total_jam_potong,0)),coalesce(j1.tunjangan_tpp/2,j.ikkd*j.nilai_jabatan,j.tpp_statis,g.ikkd*g.nilai_jabatan),100,j1.tambahan_tpp,
    ...
    {
        echo "m190211_014532_alterhitungtjg cannot be reverted.\n";
