...
/**
 * Class m190102_011739_alterlagi.
 */
class m190102_011739_alterlagi extends Migration
{
    /**
     * {@inheritdoc}
     */
...
BEGIN
         ...
         and p.id_satuan_kerja=id_satuan_kerja;
          ...
          and p.id_satuan_kerja=id_satuan_kerja;
           ...
           insert into tb_dt_hitung_tunjangan(id_hitung_tunjangan,id_pegawai,jumlah_absen,total_jam_potong,tunjangan_tpp,capaian_kinerja,tambahan_tpp,total_tunjangan)
            select id, p.id_pegawai,count(a.id_absen),sum(coalesce(a.total_jam_potong,0)),coalesce(j.ikkd*j.nilai_jabatan,j.tpp_statis,g.ikkd*g.nilai_jabatan),100,coalesce(j1.tambahan_tpp,0),
        case when  ((coalesce(j.ikkd*j.nilai_jabatan,j.tpp_statis,g.ikkd*g.nilai_jabatan)) +(coalesce(j.ikkd*j.nilai_jabatan,j.tpp_statis,g.ikkd*g.nilai_jabatan) *100/100 ))
          ...
          < 0 then coalesce(j.ikkd*j.nilai_jabatan,j.tpp_statis,g.ikkd*g.nilai_jabatan) else
    ...
    {
        echo "m190102_011739_alterlagi cannot be reverted.\n";
