...
[
                                ...
                                ['label' => 'Jabatan', 'icon' => ' fa fa-cogs', 'url' => ['/jabatan-fungsional/index'], 'visible' => !Yii::$app->user->isGuest],
                                   ['label' => 'Jabatan Tambahan', 'icon' => ' fa fa-cogs', 'url' => ['/jabatan-tambahan/index'], 'visible' => !Yii::$app->user->isGuest],
    ...
    ['label' => 'Banding', 'icon' => ' fa fa-hand-o', 'url' => ['/banding/index'], 'visible' => !Yii::$app->user->isGuest],
...
<div class="sidebar" data-color="rose" data-background-color="red" data-image="<?= Url::to('@web/creative/assets/img/sidebar-1.jpg') ?>">
