...
`        <div class="col-md-6">
    ...
    <div class="row">
        ...
        <label class="col-md-3 col-form-label">Absen Terlambat</label>
        <div class="col-md-6">
            <?= $form->field($model, 'id_absen_terlambat')->widget(DepDrop::classname(), [
                'type' => DepDrop::TYPE_SELECT2,
                'options' => ['placeholder' => 'Pilih Absen Terlambat ...'],
                'select2Options' => ['pluginOptions' => ['allowClear' => true]],
                'pluginOptions' => [
                    'depends' => ['absen-id_pegawai'],
                    'url' => Url::to(['/absen/data-terlambat']),
                    'placeholder' => 'Pilih Absen Terlambat ...',
                    'initialize' => true,
                ],
            ])->label(false); ?>
        </div>
