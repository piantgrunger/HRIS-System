...
class Penilaian extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['orientasi_pelayanan', 'integritas', 'komitmen', 'disiplin', 'kerjasama', 'kepemimpinan'], 'number', 'min' => 0, 'max' => 90],
    ...
    {
        $this->jumlah = $this->orientasi_pelayanan + $this->integritas + $this->disiplin + $this->kerjasama + (!is_numeric($this->kepemimpinan) ? 0 : $this->kepemimpinan);
