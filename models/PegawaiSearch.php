...
class PegawaiSearch extends Pegawai
{
    ...
    public function rules()
    {
        return [
            ...
            [['nip', 'nik', 'nama', 'gelar_depan', 'gelar_belakang', 'alamat', 'jenis_kelamin', 'tempat_lahir', 'tanggal_lahir', 'nama_lengkap', 'nama_golongan', 'nama_jabatan', 'nama_satuan_kerja','searchWord','dataShown'], 'safe'],
        ];
    }
